<p align="center">
  <img src="docs/img/logo.png" alt="GNU/Emacs OS, editor on silicon" width="217" height="256">
</p>
...
The Hurd variant. Real hardware (Xvfb only for now). Multi-user.
Audio. Bluetooth. Wayland. Real networking beyond `lo`. v0.2 will eat
through that list. v0.1 is about proving the core idea holds together
under a normal day of work, which it does.
...
## status
  ...
  - v0.2: scoped, not started. See [docs/ROADMAP.md](docs/ROADMAP.md).
...
GPLv3 or later, same as Emacs and Guix. See `LICENSE`.
